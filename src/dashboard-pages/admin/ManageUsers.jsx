     ...
     <Table.Body className="divide-y">
      {filter?.map(item => (
       <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800" key={item._id}>
        ...
        <Table.Cell>
         <button onClick={() => handleMakeAdmin(item)} className="font-medium text-cyan-600 hover:underline dark:text-cyan-500" name="admin">
          Admin
         </button>
        </Table.Cell>
        <Table.Cell>
         <button onClick={() => handleMakeSurveyor(item)} className="font-medium text-cyan-600 hover:underline dark:text-cyan-500" name="surveyor">
          Surveyor
         </button>
        </Table.Cell>
       </Table.Row>
